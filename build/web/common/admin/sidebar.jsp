...
<!-- Navbar-->
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="${sessionScope.account.avatar}" width="50px"
                                                alt="User Image">
                <div>
            ...
            <ul class="app-menu"><li><a class="app-menu__item" href="DispatchServlet"><i class='app-menu__icon bx bx-tachometer'></i><span
                ...
                <li><a class="app-menu__item" href="ManageProductServlet"><i
