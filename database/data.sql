...
, 'assets/img/products/3-1.jpg assets/img/products/3-2.jpg', N'Xanh' , '2023-11-01', 0, 72, 545.000,2),
...
, 'assets/img/products/4-1.jpg assets/img/products/4-2.jpg', N'Xanh đen,Trắng' , '2019-11-01', 0.31, 51, 399.000,1),
...
, 'assets/img/products/5-1.jpg assets/img/products/5-2.jpg', N'Nâu' , '2019-11-01', 0.17, 21, 315.000,1),
...
, 'assets/img/products/6-1.jpg assets/img/products/6-2.jpg', N'Xám,Trắng' , '2022-11-01', 0.15, 11, 875.000,1),
...
, 'assets/img/products/7-1.jpg assets/img/products/7-2.jpg', N'Đen' , '2022-11-01', 0., 21, 699.000,1),
...
, 'assets/img/products/8-1.jpg assets/img/products/8-2.jpg', N'Xanh rêu, Kem' , '2024-09-01', 0.34, 31, 425.000,2),
...
, 'assets/img/products/9-1.jpg assets/img/products/9-2.jpg', N'Đen, Nâu' , '2024-11-01', 0.41, 51, 2660.000,1),
...
, 'assets/img/products/10-1.jpg assets/img/products/10-2.jpg', N'Trắng,Đen,Rêu' , '2022-12-01', 0, 5, 1053.000,1),
(N'TRAVIS SCOTT CACT.US CORP X NIKE U NRG BH LONG SLEEVE T', 2, 1, 'S', 15, N'Hoạt động trong nhà/ ngoài trời.'
, 'assets/img/products/11-1.jpg assets/img/products/11-2.jpg', N'Đen' , '2024-02-01', 0.37, 76, 1100.000,1),
(N'ÁO THUN OVERSIZED *RETRO 9AS*', 5, 2, 'S,M,L', 45, N'100% COTTON, 320GSM, IN LỤA THỦ CÔNG, OVERSIZED FIT'
, 'assets/img/products/12-1.jpg assets/img/products/12-2.jpg', N'Trắng' , '2024-11-01', 0, 72, 555.000,1),
(N'QUẦN JEANS THIÊN THẦN PHUN SƠN', 5, 8, 'S,M,L', 30, N'VẢI CHÍNH: 100% SỢI BÔNG – COTTON, MẪU CAO 1M76 68KG MẶC SIZE 32'
, 'assets/img/products/13-1.jpg assets/img/products/13-2.jpg', N'Xanh' , '2019-11-01', 0.31, 51, 325.000,2),
...
, 'assets/img/products/14-1.jpg assets/img/products/14-2.jpg', N'Đỏ' , '2024-11-01', 0.17, 21, 2200.000,1),
...
, 'assets/img/products/15-1.jpg assets/img/products/15-2.jpg', N'Vàng' , '2022-11-01', 0.2, 12, 950.000,1),
(N'QUẦN SHORT JEANS ĐEN TÚI CHÉO WASH BẠC', 6, 6, 'M,L', 30, N'Phong cách: thể thao, Hàn Quốc, đường phố'
, 'assets/img/products/16-1.jpg assets/img/products/16-2.jpg', N'Đen' , '2022-11-01', 0., 21, 415.000,2),
...
, 'assets/img/products/17-1.jpg assets/img/products/17-2.jpg', N'Đen' , '2024-09-01', 0.5, 61, 1050.000,2),
...
('2024-03-10 12:30:00', 20.59, 1, 1, 'phuuthanh2003', 1),
('2024-04-20 11:19:00', 170.19, 1, 1, 'phuuthanh2003', 1),
('2018-05-19 11:30:00', 80.50, 1, 1, 'phuuthanh2003', 1),
('2022-06-10 12:30:00', 110.59, 1, 1, 'phuuthanh2003', 1),
('2018-07-20 11:19:00', 110.59, 1, 1, 'phuuthanh2003', 1),
('2019-01-19 11:30:00', 80.50, 1, 1, 'user2', 1),
('2024-01-19 11:30:00', 190.50, 1, 1, 'user2', 1),
('2020-09-10 12:30:00', 110.59, 1, 1, 'phuuthanh2003', 1),
('2021-10-20 11:19:00', 70.59, 1, 1, 'phuuthanh2003', 1),
